...
/* Middleware */
  ...
  app.get('/api/media/list', ensureLoggedIn(), (req, res) => {
  ...
  app.get('/new_music', ensureLoggedIn(), requireRole('admin'), (req, res) => {
  ...
  app.post('/api/media/new', ensureLoggedIn(), requireRole('admin'), (req, res) => {
